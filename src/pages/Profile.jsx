  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950">
        {/* Mobile Navigation Bar - hidden on desktop where sidebar shows */}
        <div className="lg:hidden sticky top-0 z-10 backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 border-b border-white/20 dark:border-gray-700/30 shadow-sm">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-scale-in">
              <div className="relative w-full max-w-3xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 max-h-[70vh] overflow-y-auto">
                  <TextEditor
                    onUpdate={(tweetId, content) =>
                      updatePost(tweetId, content)
                    }
              ...
              tweets.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="relative p-6">
                        <Post
                          ...
                          onUpdateToggle={() =>
                            toggleTextEditor(tweet?._id, tweet?.content)
                          }
                        />
                      </div>
                    </div>
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                    This user hasn't shared any posts yet. Check back later to
                    see their thoughts and updates.
                  </p>
                </div>
              )
            ) : (
